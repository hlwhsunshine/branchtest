...
public class CircleBar extends View {
    ...
    private int mTextColor = getResources().getColor(R.color.newRed);//默认文字颜色
    private int mWheelColor = getResources().getColor(R.color.newRed);//默认圆环颜色
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        mTextSize = dip2px(getContext(), 11);
        ...
        mDefaultWheelPaint.setColor(getResources().getColor(R.color.pink_red));
        ...
        textDesPaint.setColor(getResources().getColor(R.color.red));
    ...
    protected void onDraw(Canvas canvas) {
        canvas.drawArc(mColorWheelRectangle, -215, 250, false, mDefaultWheelPaint);//画外接的圆环
        canvas.drawArc(mColorWheelRectangle, -215, mSweepAnglePer, false, mColorWheelPaint);//画圆环
